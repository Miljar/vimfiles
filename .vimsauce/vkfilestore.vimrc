exec 'NERDTree vkfilestore'

let g:vdebug_options["port"] = 9000
"let g:vdebug_options["server"] = 'host.docker.internal'
let g:vdebug_options["path_maps"] = {'/phpapp': '/Users/tom/Code/Dx/vkfilestore/vkfilestore-code'}
